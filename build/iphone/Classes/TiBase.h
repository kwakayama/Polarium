...
// in simulator we redefine to format for PolarionApp Developer console
...
{\
	NSString * exceptionName = [@"org.polarionapp." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.polarionapp";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	TiExceptionThrowWithNameAndReason(exceptionName,message);\
}\
...
enum {
	UIPolarionAppNativeItemNone = -1, 
	UIPolarionAppNativeItemSpinner = -2,
	UIPolarionAppNativeItemProgressBar = -3,
	
	UIPolarionAppNativeItemSlider = -4,
	UIPolarionAppNativeItemSwitch = -5,
	UIPolarionAppNativeItemMultiButton = -6,
	UIPolarionAppNativeItemSegmented = -7,
	
	UIPolarionAppNativeItemTextView = -8,
	UIPolarionAppNativeItemTextField = -9,
	UIPolarionAppNativeItemSearchBar = -10,
	
	UIPolarionAppNativeItemPicker = -11,
	UIPolarionAppNativeItemDatePicker = -12,
	
	UIPolarionAppNativeItemInfoLight = -13,
	UIPolarionAppNativeItemInfoDark = -14,
	
	UIPolarionAppNativeItemDisclosure = -15,
	
	UIPolarionAppNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all PolarionApp instances of
