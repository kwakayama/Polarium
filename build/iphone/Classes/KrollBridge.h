...
@interface PolarionAppObject : KrollCoverageObject {
#else
@interface PolarionAppObject : KrollObject {
#endif
@private
...
extern NSString * PolarionApp$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	PolarionAppObject *_polarionapp;
	BOOL shutdown;
