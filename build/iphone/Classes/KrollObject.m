 ...
 * Copyright (c) 2009-2011 by PolarionApp, Inc. All Rights Reserved.
...
//@interface PolarionAppObject : NSObject
//@end

@interface PolarionAppObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[PolarionAppObject class]])
		{
			for (NSString *key in [[(PolarionAppObject*)o modules] allKeys])
			{
