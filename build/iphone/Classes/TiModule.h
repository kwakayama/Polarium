...
/**
 The base class for all PolarionApp modules
 */
...
/**
 PolarionApp Platform calls this method on startup.
 */
-(void)startup;

/**
 PolarionApp Platform calls this method on shutdown.
 @param sender The sender of the event.
 */
-(void)shutdown:(id)sender;

/**
 PolarionApp Platform calls this method on suspend.
 @param sender The sender of the event.
 */
-(void)suspend:(id)sender;

/**
 PolarionApp Platform calls this method on resume.
 @param sender The sender of the event.
 */
